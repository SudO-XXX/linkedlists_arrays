...
//Start a program to store the data of students in a linked list.
//takes (op)to choose(1:insertion with actual values,2:random values).
//uses head and tail global variables.
